...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between px-6 md:px-16 pt-28 md:pt-36">
        <div className="max-w-2xl">
          <div className="mb-6">
            ...
            <div className="mt-2 h-[2px] w-48 bg-gradient-to-r from-green-400 via-green-300 to-transparent shadow-[0_0_8px_rgba(34,197,94,0.8)]" />
          </div>
          ...
          <div className="mb-12 flex flex-wrap gap-4">
            ...
            <Button
              ...
              className="rounded-full border-2 border-white bg-transparent px-8 text-sm font-semibold uppercase tracking-wide text-white hover:border-green-400 hover:bg-white/10 hover:text-green-400"
            >
              READ MORE
            </Button>
          </div>
          ...
          <div className="flex gap-3">
            <div className="h-2.5 w-2.5 rounded-full bg-green-400 shadow-[0_0_8px_rgba(34,197,94,0.8)]" />
        ...
        <div className="relative animate-pulse-scale hidden lg:block">
          <div className="h-[720px] w-[540px]">
            <img
              ...
              style={{ filter: "drop-shadow(0 0 50px rgba(34,197,94,0.8)) drop-shadow(0 0 100px rgba(34,197,94,0.5))" }}
            />
          </div>
        </div>
      </div>
      ...
      <button
        onClick={() => scrollTo("about")}
        className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 text-white/50 hover:text-green-400 transition-colors duration-300"
      >
      ...
      <div className="absolute bottom-10 left-6 md:left-16 z-10 flex gap-6">
        <Twitter className="h-5 w-5 cursor-pointer text-white transition-all duration-300 hover:text-green-400 hover:drop-shadow-[0_0_12px_rgba(34,197,94,0.9)]" />
        <Linkedin className="h-5 w-5 cursor-pointer text-white transition-all duration-300 hover:text-green-400 hover:drop-shadow-[0_0_12px_rgba(34,197,94,0.9)]" />
        <Facebook className="h-5 w-5 cursor-pointer text-white transition-all duration-300 hover:text-green-400 hover:drop-shadow-[0_0_12px_rgba(34,197,94,0.9)]" />
        <Instagram className="h-5 w-5 cursor-pointer text-white transition-all duration-300 hover:text-green-400 hover:drop-shadow-[0_0_12px_rgba(34,197,94,0.9)]" />
      </div>
    </section>
  )
}
