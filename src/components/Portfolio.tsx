...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="relative bg-[#080612] overflow-hidden">
      ...
      {/* Section Header */}
      <div className="relative px-16 pt-24 pb-16 border-b-2 border-white/10">
        ...
        <div className="relative z-10 flex items-end justify-between">
          <div>
            ...
            <h2 className="text-[8rem] font-black uppercase leading-none text-white tracking-tight">
              PORT
              <span className="text-stroke">FOLIO</span>
            </h2>
          </div>
        ...
        {/* Filter tabs — brutalist pill style */}
        <div className="relative z-10 flex gap-2 mt-8">
          {FILTERS.map((f) => (
            <button
              key={f}
              onClick={() => setActive(f)}
              className={`px-5 py-2 text-xs font-black uppercase tracking-widest border-2 transition-all duration-200 ${
                active === f
      ...
      <div className="relative px-16">
        {filtered.map((p, i) => (
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-8 py-8">

              {/* Number */}
              <span
                className="text-xs font-black tabular-nums transition-colors duration-300 w-10 shrink-0"
              ...
              <div
                className="overflow-hidden rounded-xl shrink-0 transition-all duration-500"
              ...
              <div className="flex-1 min-w-0">
                <h3
                  className="text-3xl font-black uppercase leading-none tracking-tight transition-colors duration-300 truncate"
              ...
              {/* Arrow */}
              <div
                className="shrink-0 w-10 h-10 border-2 flex items-center justify-center transition-all duration-300"
                style={{
      ...
      {/* Bottom — stats bar */}
      <div className="relative px-16 py-16 mt-8">
        <div className="grid grid-cols-4 gap-0 border-2 border-white/10">
          {[
            ...
            <div
              key={i}
              className={`p-10 text-center ${i < 3 ? "border-r-2 border-white/10" : ""} group hover:bg-white/3 transition-colors duration-300`}
            >
              <p className="text-6xl font-black text-white leading-none mb-2 group-hover:text-red-400 transition-colors duration-300">
                {s.num}
              </p>
