  ...
  return (
    <section id="services" className="relative bg-[#1a1030] overflow-hidden">
      ...
      <div className="relative z-10 mx-4 md:mx-16 mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="group relative rounded-3xl overflow-hidden bg-[#0d0820] border border-white/10 h-72 cursor-pointer hover:border-red-400/30 transition-all duration-500">
        ...
        <div className="group relative sm:row-span-2 lg:row-span-2 rounded-3xl overflow-hidden border border-white/10 h-72 sm:h-full cursor-pointer hover:border-red-400/30 transition-all duration-500" style={{ background: "linear-gradient(135deg, #0a1628 0%, #0d2010 100%)" }}>
        ...
        <div className="group relative rounded-3xl overflow-hidden bg-[#120820] border border-white/10 h-72 cursor-pointer hover:border-red-400/30 transition-all duration-500">
        ...
        {/* Card 4 — Wellness */}
        <div className="group relative rounded-3xl overflow-hidden border border-white/10 h-72 cursor-pointer hover:border-red-400/30 transition-all duration-500" style={{ background: "linear-gradient(135deg, #1a0a0a 0%, #2a0f0f 100%)" }}>
        ...
        <div className="group relative rounded-3xl overflow-hidden bg-[#0a0a1a] border border-white/10 h-72 cursor-pointer hover:border-red-400/30 transition-all duration-500">
