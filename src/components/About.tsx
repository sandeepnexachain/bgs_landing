  ...
  return (
    <section id="about" className="relative min-h-screen bg-gradient-to-br from-[#3B2D6A] via-[#5B4B8A] to-[#6B4B7A] px-6 md:px-16 py-24">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-[320px_1fr_280px] gap-8 items-start">
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(239,68,68,0.15)] h-72">
          <img
        ...
        <div>
          <div className="overflow-hidden rounded-2xl border border-white/10 shadow-[0_0_30px_rgba(239,68,68,0.1)] h-36">
            <img
          ...
          <h3 className="mt-5 text-xl font-black text-white">
            Our <span className="text-red-400 drop-shadow-[0_0_10px_rgba(239,68,68,0.7)]">Philosophy</span>
          </h3>
          <div className="mt-1 h-[2px] w-10 bg-red-400 rounded-full shadow-[0_0_6px_rgba(239,68,68,0.8)]" />
      ...
      <div className="relative z-10 mt-20">
        <div className="flex items-center gap-4 mb-10">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent to-red-400/50" />
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-red-400">Leadership</p>
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="relative group">
        <div className="absolute -inset-1 rounded-3xl bg-gradient-to-br from-red-400/40 to-purple-400/20 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        <div className="relative overflow-hidden rounded-3xl border border-red-400/20 w-56 h-72 shadow-[0_0_40px_rgba(239,68,68,0.2)]">
      ...
      <div className="text-center">
        ...
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-red-400 mt-1">{role}</p>
      </div>
    </div>
  )
}
